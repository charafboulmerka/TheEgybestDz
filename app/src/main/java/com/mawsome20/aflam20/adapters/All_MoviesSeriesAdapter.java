...
public class All_MoviesSeriesAdapter extends RecyclerView.Adapter<All_MoviesSeriesAdapter.OriginalViewHolder> {
    ...
    public All_MoviesSeriesAdapter(Context context, List<mix_movies_series> items,String type) {
        this.items = items;
        this.type=type;
        ctx = context;
    }
    ...
    @Override
    public All_MoviesSeriesAdapter.OriginalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        All_MoviesSeriesAdapter.OriginalViewHolder vh;
        View v ;
    ...
    @Override
    public void onBindViewHolder(All_MoviesSeriesAdapter.OriginalViewHolder holder, final int position) {
