...
public class All_MoviesAdapter extends RecyclerView.Adapter<All_MoviesAdapter.OriginalViewHolder> {
    ...
    public All_MoviesAdapter(Context context, List<Movies> items) {
        this.items = items;
        ctx = context;
    }
    ...
    @Override
    public All_MoviesAdapter.OriginalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        All_MoviesAdapter.OriginalViewHolder vh;
    ...
    @Override
    public void onBindViewHolder(All_MoviesAdapter.OriginalViewHolder holder, final int position) {
    ...
    private void goToDetailsActivity(Movies obj) {
