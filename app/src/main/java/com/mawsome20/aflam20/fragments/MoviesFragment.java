...
import com.mawsome20.aflam20.adapters.All_MoviesAdapter;
...
public class MoviesFragment extends Fragment {
    ...
    private All_MoviesAdapter mAdapter;
    ...
    private void initComponent(View view) {
        ...
        mAdapter = new All_MoviesAdapter(getContext(), mList);
    ...
    private ArrayList<Movies> mList = new ArrayList<Movies>();
    private void getDataFirstTime(){
        mRef.child("Movies").limitToFirst(Integer.parseInt(getString(R.string.limit_fc_data))).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try{
                    ...
                    for (DataSnapshot movie :  dataSnapshot.getChildren()){
                        ...
                        mList.add(movie.getValue(Movies.class));
    ...
    private void getDataOnScroll(){
        ...
        mRef.child("Movies").orderByKey().startAt(oldKey).limitToFirst(Integer.parseInt(getString(R.string.limit_fc_data))).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try{
                    Boolean goNext = true;
