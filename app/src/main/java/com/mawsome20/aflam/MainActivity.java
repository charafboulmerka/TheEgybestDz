...
import com.mawsome20.aflam.adapters.NavigationAdapter;
import com.mawsome20.aflam.fragments.MoviesFragment;
import com.mawsome20.aflam.fragments.ReportsFragment;
import com.mawsome20.aflam.fragments.TvSeriesFragment;
import com.mawsome20.aflam.models.NavigationModel;
import com.mawsome20.aflam.nav_fragments.CategoriesFragment;
import com.mawsome20.aflam.nav_fragments.GenreFragment;
import com.mawsome20.aflam.nav_fragments.MainHomeFragment;
 ...
 */
        ...
        status =  (new PreferenceUtils(MainActivity.this)).isLoggedIn();
        if (status){
            ...
            public void onItemClick(View view, NavigationModel obj, int position, NavigationAdapter.OriginalViewHolder holder) {
                ...
                if (position==0){
                    ...
                    if (status){
                         ...
                         */
                            ...
                            new AlertDialog.Builder(MainActivity.this).setMessage("هل متأكد انك تريد تسجيل الخروج؟")
                                    .setPositiveButton("نعم", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            startActivity(intent);
                                            finish();
                                            new ToastMsg(MainActivity.this).toastIconSuccess("تم تسجيل الخروج بنجاح");
                                        }
                                    })
                                    .setNegativeButton("إلغــاء", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            dialog.cancel();
                                        }
                ...
                if (!obj.getTitle().equals("Settings") && !obj.getTitle().equals("Login") && !obj.getTitle().equals("Sign Out")){
                    ...
                    if (navMenuStyle.equals("grid")) {
                        ...
                        holder.selectedLayout.setBackground(ContextCompat.getDrawable(MainActivity.this,R.drawable.round_grey_transparent));
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Log.e("THESHITNEED", String.valueOf(AdvertisingIdClient.getAdvertisingIdInfo(MainActivity.this)));
                } catch (IOException e) {
                    e.printStackTrace();
    ...
    void intTheChosenAdNetwork(){
     //   intAd();
        //Toast.makeText(this,new DatabaseHelper(this).getConfigurationData().getAdsConfig().getMobileAdsNetwork(),Toast.LENGTH_LONG).show();
        //Toast.makeText(this,Tools.getAdNetwork(this),Toast.LENGTH_LONG).show();
        /*
        if (Tools.getAdNetwork(MainActivity.this).equalsIgnoreCase(Constants.START_APP)){
            initStartpp();
        }
    ...
    void intAd(){
        ...
        InMobiSdk.init(this, getString(R.string.inmobi_account_id), consentObject, new SdkInitializationListener() {
            @Override
    ...
    private void loadAd() {
        ...
        if (adsConfig.getAdsEnable().equals("1")) {
            ...
            if (adsConfig.getMobileAdsNetwork().equalsIgnoreCase(Constants.ADMOB)) {
                BannerAds.ShowAdmobBannerAds(MainActivity.this, adView);

            } else if (adsConfig.getMobileAdsNetwork().equals(Constants.START_APP)) {
                BannerAds.showStartAppBanner(MainActivity.this, adView,"old_method",null);
    ...
    public void onBackPressed() {
        ...
        if (mDrawerLayout.isDrawerOpen(GravityCompat.START)){
            ...
            new AlertDialog.Builder(MainActivity.this).setMessage("هل تريد الخروج من التطبيق؟")
                    .setPositiveButton("نعم", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
    ...
    private void showTermServicesDialog() {
        ...
        if (isDark) {
           // declineBt.setBackground(ContextCompat.getDrawable(this,R.drawable.btn_rounded_grey_outline));
            ...
            declineBt.setBackgroundResource(R.drawable.btn_rounded_grey_outline);
            acceptBt.setBackgroundResource(R.drawable.btn_rounded_dark);
        }
