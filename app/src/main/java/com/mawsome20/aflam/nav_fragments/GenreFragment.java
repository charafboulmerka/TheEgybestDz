...
public class GenreFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
       ...
       // bannerAd = (InMobiBanner)view.findViewById(R.id.banner);
        ...
        mAdapter = new GenreCategoryAdapter(activity, list,"genre", "");
    ...
    private void getAllGenreFC(){
        mRef.child("Genres").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void animateSearchBar(final boolean hide) {
       ...
       // bannerAd.animate().translationY(moveY).setStartDelay(100).setDuration(300).start();
