...
public class GenreCategoryAdapter extends RecyclerView.Adapter<GenreCategoryAdapter.ViewHolder> {
    ...
    public GenreCategoryAdapter(Context context, List<genres> mList, String type, String layout) {
    ...
    private void openSelectTypeDialog(genres item) {

        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        View view = LayoutInflater.from(context).inflate(R.layout.watch_download_dialog, null);

        Button goMovies = view.findViewById(R.id.dialog_go_watch_btn);
        goMovies.setText("أفلام");
        Button goSeries = view.findViewById(R.id.dialog_go_download_btn);
        goSeries.setText("مسلسلات");
        ...
        goMovies.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("isMovieSerie","movie");
        ...
        goSeries.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("title",new Tools().getArName(item.getName()));
                intent.putExtra("type",type);
                intent.putExtra("isMovieSerie","tvseries");
                Log.e("THE_ID",String.valueOf(type));
