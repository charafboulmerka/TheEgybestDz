package com.mawsome20.aflam.adapters.need_later;
...
import com.mawsome20.aflam.ReplyActivity;
...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.OriginalViewHolder> {
    ...
    public void onBindViewHolder(CommentsAdapter.OriginalViewHolder holder, final int position) {
        ...
        Picasso.get().load(obj.getUserImgUrl()).fit().centerCrop().placeholder(ContextCompat.getDrawable(ctx,R.drawable.ic_avatar)).into(holder.imageView);
