...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadAdapter.OriginalViewHolder> {
    ...
    public DownloadAdapter(Context ctx, List<String> items,  boolean isDialog) {
        this.ctx = ctx;
        this.items = items;
    ...
    public void onBindViewHolder(final DownloadAdapter.OriginalViewHolder holder, final int position) {
        ...
        final String downloadURL = items.get(position);
        holder.name.setText("الرابط "+String.valueOf((position+1)));
        ...
        holder.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // } else {
                    ...
                    //ctx.startActivity(new Intent((Activity) ctx, WebViewActivity.class).putExtra("url",url));
                try{
                    Log.e("MY_URL",downloadURL);
