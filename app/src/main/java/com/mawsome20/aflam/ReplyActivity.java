...
import com.mawsome20.aflam.adapters.need_later.ReplyAdapter;
...
public class ReplyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isDark) {
            ...
            etComment.setBackground(ContextCompat.getDrawable(this,R.drawable.rounded_black_transparent));
...
/*
    private void addComment(String comments){
        String userId = (new PreferenceUtils(ReplyActivity.this)).getUserId();
