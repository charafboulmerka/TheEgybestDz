...
public class Config {
    ...
    public static final String TERMS_URL = "https://www.home4movies.com/terms.php";
    public static final String PRIVACY_URL = "https://www.home4movies.com/privacy.php";
    public static final String BASE_URL = "https://us-central1-moviesapp-780f8.cloudfunctions.net/";
