...
class PreferenceUtils {
    ...
    fun setConfig(cnf: com.mawsome20.aflam.new_conception.models.Config) {
    ...
    fun getConfig():com.mawsome20.aflam.new_conception.models.Config{
        val mShared = mCtx!!.getSharedPreferences("CNF",Context.MODE_PRIVATE)
        return com.mawsome20.aflam.new_conception.models.Config(mShared.getString("enable_ads","true"),mShared.getString("ads_company","startapp"),mShared.getString("auto_slider","true")
    ...
    fun setProfile(user:com.mawsome20.aflam.new_conception.models.User){
    ...
    fun getProfile():com.mawsome20.aflam.new_conception.models.User{
        val mShared = mCtx!!.getSharedPreferences("USER",Context.MODE_PRIVATE)
        return com.mawsome20.aflam.new_conception.models.User(mShared.getString("UID","NULL"),mShared.getString("NAME","NULL"),mShared.getString("EMAIL","NULL"))
    }
